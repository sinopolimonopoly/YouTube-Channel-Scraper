...
def get_uploads_playlist_id(channel_id, upload_type="all"):
    ...
    # The playlist ID is actually identical to the channel id, except for the prefix. For channel @joinbois:
    # Channel id:           UCUNoEsSfUcyNlaJbieYkMvg
    # Uploads playlist id:  UUUNoEsSfUcyNlaJbieYkMvg

    # There are different prefixes for different video types
    ...
    elif upload_type == "livestreams":
        playlist_ids["livestreams"] = "UULV" + channel_id[2:]

    # All uploads
    else:
        # Still separate video types long form to distinguish in overall dataset
        playlist_ids["videos"] = "UULF" + channel_id[2:]
        playlist_ids["shorts"] = "UUSH" + channel_id[2:]
        playlist_ids["livestreams"] = "UULV" + channel_id[2:]
